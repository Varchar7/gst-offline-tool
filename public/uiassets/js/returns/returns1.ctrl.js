...
myApp.controller("returnsctrl", ['$scope', '$rootScope', 'shareData', 'g1FileHandler', '$log', 'NgTableParams', '$timeout', 'R1InvHandler', 'ReturnStructure', 'R1Util','$location',
    function ($scope, $rootScope, shareData, g1FileHandler, $log, NgTableParams, $timeout, R1InvHandler, ReturnStructure, R1Util,$location) {
        var tableCode = null,
            formName = null,
            isSezTaxpayer,
