...
myApp.service("validations", function () {
    this.formats = {
        ...
        rates: /^(0|0.25|0.1|0.10|1|1.5|1.50|3|5|6|7.5|7.50|12|18|28)$/,
    ...
    function ($q, $parse, $http, $sce, $timeout, $templateCache, $interpolate, $window, shareData, $location) {
        ...
        return {
            ...
            template: '<div class="autocomplete-holder" data-ng-mouseup="mouseup($event)" data-ng-mousedown="mousedown($event)">' +
                '  <input id="{{id}}_value" name="{{inputName}}" data-ng-model="searchStr" type="text" placeholder="{{placeholder}}"' +
                'data-ng-blur="hideResults($event)"  data-ng-focus="focusHandler()" maxlength="{{maxlength}}" minlength="{{minlength}}" class="form-control" autocapitalize="off" autocorrect="off" style="width: 77%;" autocomplete="off" data-ng-change="inputChangeHandler(searchStr)" data-ng-disabled="disableAfterSelect==\'true\' && searchStr.length > 0" data-ng-class="{\'hasclear\':disableAfterSelect}"/><span data-ng-if="disableAfterSelect==\'true\' && searchStr.length > 0" data-ng-click="resetField()" style="margin-right: 22%;" class="clearer fa fa-close"></span>' +
...
myApp.directive('autocompleteGstin', ['$q', '$parse', '$http', '$sce', '$timeout', '$templateCache', '$interpolate', '$window', 'shareData', '$location',
    function ($q, $parse, $http, $sce, $timeout, $templateCache, $interpolate, $window, shareData, $location) {
        ...
        return {
            ...
            template: '<div class="autocomplete-holder" data-ng-mouseup="mouseup($event)" data-ng-mousedown="mousedown($event)">' +
                '  <input id="{{id}}_value" name="{{inputName}}"  data-ng-model="searchStr" type="text" placeholder="{{placeholder}}"' +
                'data-ng-blur="hideResults($event)"  data-ng-focus="focusHandler()" maxlength="{{maxlength}}" minlength="{{minlength}}" class="form-control" autocapitalize="off" autocorrect="off" autocomplete="off" data-ng-change="inputChangeHandler(searchStr)" data-ng-style="gstinUser(result.registrationStatus)" data-ng-readonly="disableAfterSelect==\'true\' || disableForEdit==\'true\'" data-ng-disabled="disableForEdit==\'true\'" data-ng-class="{\'hasclear\':disableAfterSelect}"/><span data-ng-if="disableAfterSelect==\'true\' && searchStr.length > 0" data-ng-click="resetField()" style="display: block;float: left;margin-top: 0%;" class="clearer fa fa-close"></span>' +
                '  <div id="{{id}}_dropdown" class="autocomplete-dropdown" ng-show="showDropdown" ng-class="{\'dpdwn\' : !showViewAll && results.length>5 }">' +
                '    <div class="autocomplete-searching" ng-show="searching" ng-bind="textSearching"></div>' +
